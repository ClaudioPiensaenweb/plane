...
export const ProjectSettingsMemberDefaults = observer(function ProjectSettingsMemberDefaults(
  ...
  return (
    <div className="my-6 flex flex-col gap-y-6">
      <DefaultSettingItem title="Responsable del proyecto" description="Select the project lead for the project.">
        {currentProjectDetails ? (
          <Controller
            control={control}
            name="project_lead"
      ...
      <DefaultSettingItem title="Responsable por defecto" description="Select the default assignee for the project.">
        {currentProjectDetails ? (
          <Controller
            control={control}
