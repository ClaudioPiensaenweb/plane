...
| **Fecha en los fichajes** | `piensaenweb/fichajes.tsx` | El día en que se trabajó, no el día en que se apunta: lo del viernes apuntado el lunes descuadraba el cierre de mes |
